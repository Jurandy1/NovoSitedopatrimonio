/**
 * /src/admin/tabSobrantesSearch.js
 * Lógica da aba "Tombos Sobrando" (content-sobrando - Busca global de sobras).
 * OBS: A lógica de CONCILIAR com sobras está em tabConciliar.js
 */
...
function getGlobalLeftovers() {
    ...
    // Como esta é a busca global, não consideramos linksToCreate, mas sim o estado atual do inventário
...
export function setupSobrantesSearchListeners() {
